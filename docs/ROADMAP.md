...
Status as of **v0.5.0**. Hardware verification on **board1** (ProMicro clone,
...
| **UX (v0.5)** | `NIUS_*_BYTES` buffer macros, `NIUS_OK` / `cryptoOk`, `RsaKeyPair` explicit handle, message-level ECDSA/Ed25519 helpers, friendly RSA/ChaCha aliases |
